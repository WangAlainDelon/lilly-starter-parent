 ...
 * 默认图像验证码生成实现类
 */
public class ValidateImageGenerator implements ValidateGenerator {

    private SecurityProperties securityProperties;

    public ValidateImageGenerator(SecurityProperties securityProperties) {
    ...
    public ImageCode generator() {
        ...
        return new ImageCode(image, sRand,
                securityProperties.getValidateCode().getImageCode().getExpireTime());
    }
